...
<div class="dropdown pull-right"> 
    ...
    if ($itemCount == 0)
    {
        ?>
        <li>
            <p class="text-center"><?php echo UsniAdaptor::t('cart', 'tu carro de compras esta vacio!'); ?></p>
        </li>
        <?php
    }
    else
    {
        ?>
        <li>
            <div class="header-cart-title"><?php echo UsniAdaptor::t('cart', 'Ver Carro');?></div>
        </li>
        <li>
            <table class="table">
                <tbody>
            ...
            <div>
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <tr>
                            <td class="text-right"><strong><?php echo UsniAdaptor::t('tax', 'Iva'); ?></strong></td>
                ...
                <p class="text-right">
                    <a href="<?php echo UsniAdaptor::createUrl('cart/default/view');?>"><?php echo UsniAdaptor::t('cart', 'Ver Carro');?></a> | 
