...
class BeforeActionBehavior extends \backend\web\BeforeActionBehavior
{
    ...
    public function checkIsSelectedStoreActive()
    {
        ...
        {
            throw new Exception(UsniAdaptor::t('stores', 'La tienda seleccionada no esta activa.'));
        }
        ...
        {
            throw new Exception(UsniAdaptor::t('stores', 'La informacion de la tienda no esta disponible.'));
        }
    }
