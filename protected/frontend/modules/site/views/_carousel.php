...
<div class="carousel slide hidden-xs" data-ride="carousel" id="carousel-captions">
    ...
    <div class="carousel-inner" style="">
        <div class="item active"><?php echo Html::img($assetsUrl . '/images/spinner1.jpg');?></div>

        <div class="item "><?php echo Html::img($assetsUrl . '/images/spinner2.jpg');?></div>

        <div class="item "><?php echo Html::img($assetsUrl . '/images/spinner3.jpg');?></div>
    </div>
